// Módulo de Galería Optimizado - Carga bajo demanda
export class GalleryModule {
  constructor() {
    this.images = [
      {id:1,src:"/imag/granja4.webp",alt:"Granja avícola moderna en Venezuela",title:"Granja Avícola Moderna",description:"Instalaciones avícolas de última generación",category:"avicola"},
      {id:2,src:"/imag/granja6.webp",alt:"Granja avícola moderna",title:"Instalaciones Avícolas",description:"Sistemas de producción avícola optimizados",category:"avicola"},
      {id:3,src:"/imag/aves4.webp",alt:"Acompañamiento técnico",title:"Acompañamiento Técnico",description:"Nuestro equipo brindando asesoría especializada",category:"servicios"},
      {id:4,src:"/imag/operador1.webp",alt:"Granja porcina",title:"Instalaciones Porcinas",description:"Producción porcina con estándares internacionales",category:"porcina"},
      {id:5,src:"/imag/granja1.webp",alt:"Planta de alimentos",title:"Planta de Alimentos",description:"Procesamiento de alimentos balanceados",category:"procesamiento"},
      {id:6,src:"/imag/a.webp",alt:"Laboratorio de calidad",title:"Control de Calidad",description:"Análisis y control de calidad de productos",category:"laboratorio"},
      {id:7,src:"/imag/aa.webp",alt:"Equipo veterinario",title:"Equipo Veterinario",description:"Profesionales especializados en salud animal",category:"servicios"},
      {id:8,src:"/imag/b.webp",alt:"Equipo Agrolinx en granja porcina",title:"Equipo Técnico Agrolinx",description:"Nuestro equipo trabajando en campo",category:"servicios"}
    ];
    this.currentSlide = 0;
  ...
  render() {
    ...
    track.innerHTML = this.images.map((img, i) => 
      `<div class="gallery-carousel__slide" data-index="${i}">
        <img src="${img.src}" alt="${img.alt}" class="gallery-carousel__image" loading="lazy">
      </div>`
    ).join('');
